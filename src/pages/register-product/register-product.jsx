...
function RegisterProduct() {
  ...
  const [sizeTypeIsNumber, setSizeTypeIsNumber] = useState(false);
  ...
  const onChangeTypeSize = (event) => {
    setSizeTypeIsNumber(event.target.value !== "notNumber");
  };
        ...
        <div className={style.Container}>
          ...
          <div className={style.Form}>
              ...
              <Input
                ...
                min={1}
              />
              <div onChange={onChangeTypeSize} className={style.RadioSizeType}>
                <div>
                <input type="radio" value="notNumber" name="sizeType" /> P, M, G...
                </div>
                <div>
                <input type="radio" value="number" name="sizeType" /> 36, 38, 40...
              </div>
              </div>
              {sizeTypeIsNumber ? (
                <Input
